...
class LendingController extends AbstractController
{
    ...
    public function add(Request $request): JsonResponse
    {
        ...
        $lending->setId($request->request->get('id'));
    ...
    public function find(int $id): JsonResponse
    {
        ...
        if (!$lending) return $this->json(['code' => 1, 'message' => 'Fiche de pret introuvable'], 404);
    ...
    public function update(int $id, Request $request): JsonResponse
    {
        ...
        $lending->setId($request->request->get('id'), $lending->getId());
        ...
        $lending->setEndDate($request->request->get('end_date'), $lending->getEndDat());
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return $this->json(['code' => 0, 'message' => 'Fiche de pret supprimé']);
    }
}